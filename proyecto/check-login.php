...
<html lang="en">
	<head>
		<title>Verificacion de Inicio de Sesión</title>
	...
	<body>
		<div class="container">
			...
			if (password_verify($_POST['password'], $hash)) {	
				...
				<p>		
				<p><a href='edit-profile.php'>Empiece a Navegar</a></p>	
				<p><a href='logout.php'>Cerrar Sesión</a></p></div>";	
			
			} else {
				echo "<div class='alert alert-danger mt-4' role='alert'>Ha ocurrido un error, su email o contraseña son incorrectos!
				<p>	
